...
router.route('/:id').get(_authorization.default.checkForToken, _authorization.default.verifyCaterer, _mealServices.default.findMealById).put(_authorization.default.checkForToken, _authorization.default.verifyCaterer, _validate.default.validateMealCreator, _meal.default.validateMealUpdate, _mealServices.default.findMealByIdAndUpdate).delete(_authorization.default.checkForToken, _authorization.default.verifyCaterer, _validate.default.validateMealCreator, _mealServices.default.findMealByIdAndDelete);
var _default = router;
